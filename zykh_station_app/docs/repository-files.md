...
| 可重建固件 | 跟踪源码重建得到 1500 字节固件，SHA-256 `897129e7ec7b448e47af0c072e17bcc5fc511abda960f752867e4d250e408271` |
| CloudBase | `cloudbase/` 不属于本次三分类柜修改范围，保持发布前基线代码与 23 项 `hardware_slot` 契约 |
