...
const checks = [
  ...
  [review.includes("networkStatusRef.current") && review.includes("[ready, session?.session_id]"), "information review speech must run once per review state, independent of network refreshes"],
