...
export const INQUIRY_VITALS_AWAITING_KEY = "zykh-inquiry-awaiting-vitals";
export const INQUIRY_BACKEND_SESSION_KEY = "zykh-inquiry-backend-session";

export function clearInquirySession() {
  try {
    [INQUIRY_DRAFT_KEY, INQUIRY_CHAT_DRAFT_KEY, INQUIRY_VITALS_AWAITING_KEY, INQUIRY_BACKEND_SESSION_KEY].forEach((key) => {
